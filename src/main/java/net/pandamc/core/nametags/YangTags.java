...
import net.pandamc.yang.Yang;
import net.pandamc.yang.match.participant.MatchGamePlayer;
import net.pandamc.yang.profile.Profile;
import net.pandamc.yang.profile.ProfileState;
...
public class YangTags extends NametagProvider {
    ...
    public NametagInfo fetchNametag(Player target, Player viewer) {
        ...
        if (viewerProfile.getState() == ProfileState.LOBBY || viewerProfile.getState() == ProfileState.QUEUEING) {
            ...
            return createNametag("&b[Staff] " + targetProfile.getColor(), "");
        }
