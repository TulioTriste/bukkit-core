package net.pandamc.core.util.menu.menus;

import net.pandamc.core.util.menu.Button;
import net.pandamc.core.util.menu.Menu;
import net.pandamc.core.util.menu.button.ConfirmationButton;
import net.pandamc.core.util.menu.callback.TypeCallback;
