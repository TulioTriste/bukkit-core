package net.pandamc.core.util.file.type;

import net.pandamc.core.Core;
import net.pandamc.core.util.file.AbstractConfigurationFile;
...
public class BasicConfigurationFile extends AbstractConfigurationFile {
    ...
    public void reload(){
        File file = new File(Core.get().getDataFolder(), getName() + ".yml");
        try {
    ...
    public void save() {
        File folder = Core.get().getDataFolder();
        try {
